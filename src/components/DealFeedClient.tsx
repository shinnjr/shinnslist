      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        {filtered.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">No deals found</h2>
            <p className="text-[var(--shinnslist-muted)]">
              Try a different vertical or expand your search area.
            </p>
          </div>
        ) : (
            ...
            {filtered.map((deal) => {
              ...
              return (
                <a
                  ...
                  className="group bg-[var(--shinnslist-surface)] border border-[var(--shinnslist-border)] rounded-2xl overflow-hidden hover:border-zinc-600 transition-all hover:shadow-lg hover:shadow-[var(--shinnslist-pink)]/5"
                >
                  {/* Image placeholder */}
