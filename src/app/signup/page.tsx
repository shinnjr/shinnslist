    ...
    <main className="flex-1 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <p className="text-[var(--shinnslist-muted)] text-sm mt-1">Pick your interests, get alerts in 60 seconds</p>
        </div>
        ...
        <p className="text-center text-[var(--shinnslist-muted)] text-sm mt-6">
          ...
          <a href="/login" className="text-[var(--shinnslist-pink)] hover:underline">Sign in</a>
        </p>
      </div>
    </main>
  );
